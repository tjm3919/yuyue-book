...
<script lang="ts" setup>
	...
	const toLogin = () => {
		...
		axios.post('http://localhost:8000/jwt/queryById/1001?said=1001',{
            headers: { 'content-type': 'application/json','jwttoken': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJqd3RkZW1vIiwidWlkIjoiMTAwMSIsInVuYW1lIjoiYWRtaW4iLCJleHAiOjE2NzU0ODUxMDAsImlhdCI6MTY3NTQ4NDUwMDAzMn0.edOhSDWI4HbLfoin8bIXVux6UNzFoImebyhsaZkV5vzGi0U9Ms6QyJD4Pf57AYZAzgrMWaa0ohy6_l6ifpRsdA'} //store.state.userInfo.token
        })
        ...
        // axios.post('http://localhost:8084/jwt/validateAccount',qs.parse(ruleForm),{
        //     // headers: { 'content-type': 'application/json', 'jwtAuth': GlobalStore().userInfo.token, }
        // })
        // .then(function(response){
        //     console.log("response:",response.data.data)
        // }).catch(function(error){
