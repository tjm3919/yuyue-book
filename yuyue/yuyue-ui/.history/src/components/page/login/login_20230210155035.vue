<template>
	<div class="big_div">
		<!-- <img src="@/image/img/veer-435833954.jpg" class="bg"/> -->
		<div class="login_div">
			<h3 class="title">愉悦图书馆管理系统</h3>
			<!-- 注册 -->
		...
		<el-input v-model="href" placeholder="请输入地址" class="input-with-select" >
			<template #append>
				<el-button icon="Search" />
			</template>
		</el-input>
		<el-input v-model="href" @click="toTest(href)" placeholder="请输入地址" suffix-icon="Search"/>
	</div>
</template>
...
<style lang="scss" scoped>
	.big_div{
		width: 100%;
		height: 100%;
		background-image: url("@/image/img/veer-435833954.jpg");
