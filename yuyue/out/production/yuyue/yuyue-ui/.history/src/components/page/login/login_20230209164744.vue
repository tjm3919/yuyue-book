<template>
	...
	<!-- 注册 -->
	  <el-form ref="ruleFormRef2" :model="Register" status-icon :rules="rules2" label-width="120px" class="demo-ruleForm" 
			...
			<el-form-item label="用户名:" prop="suName">
				<el-input v-model="Register.suId" type="text" autocomplete="off" />
			</el-form-item>
...
<script lang="ts" setup>
	...
	const validatePassword2 = (rule: any, value: any, callback: any) => {
		setTimeout(() => {
			...
			}else if(pass2.value!=Register.saPassword) {
	...
	// 验证用户名
	const validatsuName = (rule: any, value: any, callback: any) => {
		console.log(value)
		if (!value) {
	...
	const rules2 = reactive({
		...
		suName: [{ required: true,validator: validatsuName,trigger: 'blur' }],
